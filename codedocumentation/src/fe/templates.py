#!/usr/bin/env python3
"""
HTML templates for the CodeDocumentation web application.
"""
...
<head>
    ...
    <title>CodeDocumentation - GitHub Repository Documentation Generator</title>
    <style>
        :root {
