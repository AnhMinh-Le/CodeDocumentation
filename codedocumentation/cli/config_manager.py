...
from codedocumentation.cli.models.config import Configuration
from codedocumentation.cli.utils.errors import ConfigurationError, FileSystemError
from codedocumentation.cli.utils.fs import ensure_directory, safe_write, safe_read


# Keyring configuration
KEYRING_SERVICE = "codedocumentation"
KEYRING_API_KEY_ACCOUNT = "api_key"

# Configuration file location
CONFIG_DIR = Path.home() / ".codedocumentation"
...
class ConfigManager:
    """
    Manages CodeDocumentation configuration with secure keyring storage for API keys.
    
    Storage:
        - API key: System keychain via keyring (macOS Keychain, Windows Credential Manager, 
                  Linux Secret Service)
        - Other settings: ~/.codedocumentation/config.json
    """
