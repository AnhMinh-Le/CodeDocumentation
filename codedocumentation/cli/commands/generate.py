...
from codedocumentation.cli.utils.repo_validator import (
    validate_repository,
...
from codedocumentation.cli.utils.logging import create_logger
from codedocumentation.cli.adapters.doc_generator import CLIDocumentationGenerator
from codedocumentation.cli.utils.instructions import display_post_generation_instructions
from codedocumentation.cli.models.job import GenerationOptions
...
def generate_command(
    ...
    $ codedocumentation generate --create-branch --github-pages
    
    \b
    # Force full regeneration
    $ codedocumentation generate --no-cache
    """
    ...
    try:
        ...
        if not config_manager.load():
            raise ConfigurationError(
                ...
                "Please run 'codedocumentation config set' to configure your LLM API credentials:\n"
                "  codedocumentation config set --api-key <your-api-key> --base-url <api-url> \\\n"
                "    --main-model <model> --cluster-model <model>\n\n"
                "For more help: codedocumentation config --help"
            )
        
        if not config_manager.is_configured():
            raise ConfigurationError(
                "Configuration is incomplete. Please run 'codedocumentation config validate'"
            )
        ...
        if create_branch:
            ...
            from codedocumentation.cli.git_manager import GitManager
