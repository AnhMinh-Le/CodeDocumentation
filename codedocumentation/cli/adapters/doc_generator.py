...
from codedocumentation.cli.utils.progress import ProgressTracker
from codedocumentation.cli.models.job import DocumentationJob, LLMConfig
from codedocumentation.cli.utils.errors import APIError

# Import backend modules
from codedocumentation.src.be.documentation_generator import DocumentationGenerator
from codedocumentation.src.config import Config as BackendConfig, set_cli_context
...
class CLIDocumentationGenerator:
    ...
    def _configure_backend_logging(self):
        ...
        from codedocumentation.src.be.dependency_analyzer.utils.logging_config import ColoredFormatter
        
        # Get backend logger (parent of all backend modules)
        backend_logger = logging.getLogger('codedocumentation.src.be')
    ...
    async def _run_backend_generation(self, backend_config: BackendConfig):
        ...
        from codedocumentation.src.be.cluster_modules import cluster_modules
        from codedocumentation.src.utils import file_manager
        from codedocumentation.src.config import FIRST_MODULE_TREE_FILENAME, MODULE_TREE_FILENAME
    ...
    def _run_html_generation(self):
        ...
        from codedocumentation.cli.html_generator import HTMLGenerator
