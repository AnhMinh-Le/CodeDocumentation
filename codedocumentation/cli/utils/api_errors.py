    ...
    def handle_api_error(
        ...
        if "429" in error_message or "rate limit" in error_message.lower():
            ...
            message = (
                ...
                "Troubleshooting:\n"
                "  1. Verify your API key: codedocumentation config show\n"
                "  2. Update your API key: codedocumentation config set --api-key <new-key>\n"
            ...
            message = (
                ...
                "Troubleshooting:\n"
                "  1. Check your internet connection\n"
                "  2. Verify the base URL: codedocumentation config show\n"
            ...
            message = (
                ...
                "Troubleshooting:\n"
                "  1. Check your configuration: codedocumentation config validate\n"
