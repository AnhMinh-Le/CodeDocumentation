"""
Configuration data models for CodeDocumentation CLI.

This module contains the Configuration class which represents persistent
user settings stored in ~/.codedocumentation/config.json. These settings are converted
...
class Configuration:
    """
    CodeDocumentation configuration data model.
