"""
Git operations manager for CodeDocumentation CLI.
"""
        ...
        if not force:
            ...
            if not is_clean:
                raise RepositoryError(
                    ...
                    "  # or\n"
                    "  git stash\n\n"
                    "Then re-run: codedocumentation generate --create-branch"
                )
        
        # Generate branch name with timestamp
        timestamp = datetime.now().strftime("%Y%m%d-%H%M%S")
        branch_name = f"docs/codedocumentation-{timestamp}"
